...
from inclearn.convnet import (
    ...
    resnet_mtl, ucir_resnet, vgg, dyna_resnet
)
...
def get_convnet(convnet_type, **kwargs):
    ...
    elif convnet_type == "dynaresnet18":
        return dyna_resnet.resnet18(**kwargs)
    elif convnet_type == "dynaresnet50":
        return dyna_resnet.resnet50(**kwargs)
